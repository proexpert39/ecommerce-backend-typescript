...
var ProductController = /** @class */ (function () {
    ...
    ProductController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, productService.create(req.body)];
                    case 1:
                        product = _a.sent();
    ...
    ProductController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, productService.update(Number(req.params.id), req.body)];
                    case 1:
                        product = _a.sent();
                        res.json(product);
                        return [2 /*return*/];
    ...
    ProductController.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, productService.delete(Number(req.params.id))];
                    case 1:
                        _a.sent();
                        res.status(204).end();
                        return [2 /*return*/];
